...
/// @note the generators are expected to be of pointer type
        ...
        class ChainedLUXEGeometryIdGenerator : public IGeometryIdGenerator {
        public:
            struct Cache {
                /// The caches
            ...
            /// @param mlogger is the logging instance
            ChainedLUXEGeometryIdGenerator(const std::tuple<generators_t...>&& gens,
                                       std::unique_ptr<const Logger> mlogger =
                                       getDefaultLogger("ChainedLUXEGeometryIdGenerator",
                                                        Logging::INFO))
