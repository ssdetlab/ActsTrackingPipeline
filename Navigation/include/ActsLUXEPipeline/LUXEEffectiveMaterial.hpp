...
// TEMPORARY HEADER UNTIL MATERIAL DECORATOR IS MERGED AO ACTS::CORE
...
// utility function to build material slab used to approximate scattering and energy loss
