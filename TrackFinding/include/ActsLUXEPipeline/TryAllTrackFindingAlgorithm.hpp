...
#include "ActsLUXEPipeline/detail/SeedTree.hpp"
...
class TryAllTrackFindingAlgorithm : public IAlgorithm {
    public:
        ...
        ProcessCode execute(const AlgorithmContext& ctx) const override {
            ...
            std::cout << "TRACK FINDING ALL: INPUT SEEDS SIZE = " << input.size() << std::endl;
            ...
            std::cout << "TRACK FINDING ALL: OUT SEEDS SIZE = " << trackCandidates.size() << std::endl;
    ...
    private:
        ...
        void constructTracks(
            std::shared_ptr<SeedTree::Node> root,
