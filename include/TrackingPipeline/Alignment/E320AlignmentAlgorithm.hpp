...
/// @brief E320-specific algorithm perfroming tracking detector local and global alignment
///
...
class E320AlignmentAlgorithm final : public IAlgorithm {
 public:
  ...
  E320AlignmentAlgorithm(const Config& cfg, Acts::Logging::Level lvl);
 ...
 private:
  ...
  ReadDataHandle<E320IndexSeeds> m_inputTrackCandidates{this,
