...
/// @brief Class performing update of the local alignment parameters
class LocalAlignmentTransformUpdater {
 public:
  ...
  LocalAlignmentTransformUpdater(const Config& cfg, Acts::Logging::Level level);
