...
/// @brief E320-specific reader of fitted sim tracks
class E320RootSimTrackReader : public IReader {
 public:
  ...
  E320RootSimTrackReader(const E320RootSimTrackReader&) = delete;
  E320RootSimTrackReader(const E320RootSimTrackReader&&) = delete;
  ...
  E320RootSimTrackReader(const Config& config, Acts::Logging::Level level);

  /// Writer name() method
  std::string name() const override { return "E320RootSimTrackReader"; }
