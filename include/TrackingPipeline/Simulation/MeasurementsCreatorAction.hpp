...
struct MeasurementsCreatorAction {
    ...
    void operator()(
        ...
        const Acts::Logger &logger) const {
            ...
            const auto id = 
                ActsFatras::Barcode().setVertexPrimary(1).setParticle(1);
            auto simParticle = 
                ActsFatras::Particle(id, stepper.particleHypothesis(state.stepping).absolutePdg());
            ...
            if (surface->surfaceMaterial() != nullptr) {
                ...
                auto psm = dynamic_cast<const Acts::ProtoSurfaceMaterial*>(surface->surfaceMaterial());
                ...
                scatteredParameters[Acts::eBoundTheta] = 
                    (std::abs(std::sin(simParticle.theta())) > 1e-6) ? simParticle.theta() : 1e-6;
            }
