...
class NormalKDE {
    public: 
        ...
        NormalKDE(
            ...
            Acts::ActsScalar sensitivity) 
                : m_sample(sample) {
                    ...
                    Vector scale = 
                        (mu2 - mu.cwiseProduct(mu)).cwiseSqrt();
                    ...
                    for (std::size_t i = 0; i < Dim; i++) {
                        ...
                        Acts::ActsScalar q1 = 
                            sample.at(sample.size() / 4)(i);
                        Acts::ActsScalar q3 = 
                            sample.at(3 * sample.size() / 4)(i);
                        iqr(i) = q3 - q1;
                    }
        ...
        Vector sample(RandomEngine& rng) {
            ...
            Vector bw = (m_bandwidths.size() == 1) ? 
                m_bandwidths.at(0) : m_bandwidths.at(index(rng));

            std::normal_distribution<> normal(0, 1);

            return mean + 
                bw.cwiseProduct(Eigen::VectorXd{mean.size()}.unaryExpr(
    ...
    private: 
        ...
        Vector normalKernelSecondDerivative(
        ...
        Vector sheatherJonesBW(
            ...
            Vector pilotBandwidth) {
                ...
                rSecondDerivative = RK * rSecondDerivative.cwiseInverse() / n; 
