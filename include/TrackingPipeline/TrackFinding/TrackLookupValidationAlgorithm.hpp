...
class TrackLookupValidationAlgorithm : public IAlgorithm {
 public:
  ...
  using TrackEstimator =
      Acts::Delegate<std::pair<Acts::CurvilinearTrackParameters,
  ...
  /// @brief Constructor
  TrackLookupValidationAlgorithm(const Config& config,
 ...
 private:
  ...
  ReadDataHandle<SimClusters> m_inputClusters{this, "InputSimClusters"};
  ...
  WriteDataHandle<std::vector<Acts::CurvilinearTrackParameters>>
      m_outputRefLayerPars{this, "OutputRefLayerPars"};
