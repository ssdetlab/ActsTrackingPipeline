...
GlobalAlignmentTransformUpdater::GlobalAlignmentTransformUpdater(
    const Config& cfg, Acts::Logging::Level level)
    : m_cfg(cfg),
      m_logger(
          Acts::getDefaultLogger("GlobalAlignmentTransformUpdater", level)) {}

bool GlobalAlignmentTransformUpdater::updateAlignmentParameters(
