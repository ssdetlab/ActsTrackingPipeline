...
E320::E320RootTrackWriter::E320RootTrackWriter(const Config& config,
...
ProcessCode E320::E320RootTrackWriter::finalize() {
  if (m_file != nullptr) {
    m_file->Write();
    m_file->Close();
  }
...
ProcessCode E320::E320RootTrackWriter::write(const AlgorithmContext& ctx) {
