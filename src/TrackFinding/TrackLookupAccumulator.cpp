...
TrackLookupGrid 
TrackLookupAccumulator::finalizeLookup() {
    auto meanTrack = 
        [&](const Acts::CurvilinearTrackParameters& track, std::size_t count) {
            return Acts::CurvilinearTrackParameters(
                track.fourPosition() / count,
...
TrackLookupAccumulator::addTrackParameters(
